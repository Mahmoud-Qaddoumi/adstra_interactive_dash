...
if len(numeric_cols) >= 1:
    ...
    num_selector = dcc.Checklist(id='cat_numerical_cols_id', options=numeric_cols, value=numeric_cols, inline=True,
    ...
    if len(categorical_cols) > 1:
        ...
        cat_options = dcc.Dropdown(id='cat_num_options_id', options=categorical_cols,
